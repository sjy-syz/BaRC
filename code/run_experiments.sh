#!/bin/sh
python train.py backreach --run_name fixT_01 --gym_env PlanarQuad-v0 --seed 2000 --num_iters 40 --debug

python train.py ppo_only --run_name ppo_only_01 --gym_env PlanarQuad-v0 --seed 2000 --num_iters 40 --debug

python train_syz.py backreach --run_name heu_01 --gym_env PlanarQuad-v0 --seed 2000 --num_iters 40 --debug

python train.py backreach --run_name adaptT_01 --gym_env PlanarQuad-v0 --seed 2000 --num_iters 40 --schedule_horizon --debug
