...
def update_back_rectangle(delta_t=0.1, **kwargs):
    ...
    br_engine.update_boundary(delta_t)

    return


def sample_from_back_rectangle(N_new, **kwargs):
    br_engine = kwargs['br_engine']
    problem = kwargs['problem']
    variation = kwargs['variation']
    ...
    new_starts_arr = br_engine.sample_from_backrec(size=N_new, method=kwargs['brs_sample'])
